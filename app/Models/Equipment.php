...
class Equipment extends Model
{
    ...
    protected $fillable = ['equipment_type_id', 'brand', 'model', 'acquired_date', 'location_id', 'serial_number', 'mr_no', 'person_accountable_id', 'person_accountable_unit_id', 'remarks'];
